...
export type CreateWalletResult = { Created: WalletDisplay } | { Failed: string }
...
export type SignTransactionRecurringPayment = {
    wallet_id: WalletId
...
export type SignTransactionRecurringPaymentResult =
    | { Signed: TransactionSigned }
    | { InvalidAuth: null }
    | { Failed: string }
